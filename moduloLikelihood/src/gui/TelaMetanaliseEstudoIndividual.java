...
public class TelaMetanaliseEstudoIndividual extends javax.swing.JFrame {
    ...
    MetEstInd_PercentualIntConf_label.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
    ...
    private void atualizaTela(MetanaliseEstudoIndividual metEstInd, String estInd_titulo){
        ...
        if(!(metEstInd == null)){
            ...
            this.MetEstInd_LKPositiva_text.setText(String.valueOf(metEstInd.getLikelihoodPositiva()));
            ...
            this.MetEstInd_IntConfSupLKPositiva_text.setText(String.valueOf(metEstInd.getIntervaloConfiancaLkpositivaZPositivo()));
